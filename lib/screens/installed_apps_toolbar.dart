...
/// The top toolbar for filtering, sorting, and changing the view mode of installed applications.
class InstalledAppsToolbar extends StatelessWidget {
  final HomeState state;

  const InstalledAppsToolbar({super.key, required this.state});
        ...
        children: [
          ...
          Expanded(
            ...
            child: TextField(
              ...
              textAlignVertical: TextAlignVertical.center, // Keeps the text perfectly centered
          ...
          IconButton(
            ...
            tooltip: 'Re-scan Applications',
            onPressed: () {
              state.setLoading(true);
              state.fetchFlatpakList();
            },
          ),
        ],
      ),
