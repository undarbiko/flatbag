...
class FlatpakService {
  ...
  Future<List<FlatpakApp>> getInstalledApps() async {
      ...
      if (result.exitCode == 0) {
        ...
        for (var line in lines) {
          ...
          if (columns.length >= 13) {
            ...
            final installDate = _getInstallDate(appId);
            final desktopInfo = _parseDesktopInfo(appId);
            final categories = desktopInfo.categories;
            final iconPath = _getIconPath(appId, desktopInfo.iconName);
            final permissions = _getPermissions(appId);
  ...
  Future<int> executeAppCommand(String appId) async {
    int exitCode = 1;
    try {
  ...
  Future<int> uninstallAppCommand(
    String appId,
    String? installation, {
  ...
  Future<List<FlatpakApp>> getUpdates() async {
  ...
  Future<int> updateAppCommand(String appId, {void Function(String line)? onStdOut, void Function(String line)? onStdErr}) async {
    int exitCode = 1;
    try {
  ...
  DateTime? _getInstallDate(String appId) {
    final String? home = Platform.environment['HOME'];
  ...
  String? _getIconPath(String appId, String? iconName) {
    final String? home = Platform.environment['HOME'];
  ...
  List<String> _getPermissions(String appId) {
    final String? home = Platform.environment['HOME'];
  ...
  DesktopInfo _parseDesktopInfo(String appId) {
    final String? home = Platform.environment['HOME'];
